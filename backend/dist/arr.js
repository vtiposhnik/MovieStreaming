...
exports.mockData = [
    ...
    {
        "id": 7,
        "name": "41-Year-Old Virgin Who Knocked Up Sarah Marshall and Felt Superbad About It, The",
        "genre": "Comedy",
    ...
    },
    {
        ...
        "genre": "Action|Animation|Children|Fantasy",
    ...
    {
        "id": 13,
        "name": "Man, Woman and Beast (L'uomo la donna e la bestia)",
        "genre": "Drama|Fantasy",
    ...
    {
        "id": 16,
        "name": "Prize Winner of Defiance Ohio, The",
        "genre": "Drama",
    ...
    {
        "id": 22,
        "name": "Farewell, My Queen (Les adieux à la reine)",
        "genre": "Drama|Romance",
    ...
    {
        "id": 27,
        "name": "Wild, Wild Planet (I criminali della galassia)",
        "genre": "Sci-Fi",
    ...
    {
        "id": 30,
        "name": "House of the Seven Gables, The",
    ...
    {
        "id": 34,
        "name": "Art of Crying, The (Kunsten at græde i kor)",
        "genre": "Drama",
    ...
    {
        "id": 42,
        "name": "Paper Will Be Blue, The (Hîrtia va fi albastrã)",
        "genre": "Action|Drama",
    ...
    {
        "id": 45,
        "name": "King of Ping Pong, The (Ping-pongkingen)",
        "genre": "Drama",
    ...
    {
        "id": 46,
        "name": "Beginner's Guide to Endings, A",
        "genre": "Comedy|Drama",
    ...
    {
        "id": 47,
        "name": "Diary of a Country Priest (Journal d'un curé de campagne)",
        "genre": "Drama",
    ...
    {
        "id": 63,
        "name": "Tale of Winter, A (a.k.a. A Winter's Tale) (Conte d'hiver)",
        "genre": "Drama",
    ...
    {
        "id": 68,
        "name": "Man Who Came to Dinner, The",
        "genre": "Comedy",
    ...
    {
        "id": 69,
        "name": "Wankers, The (Les branleuses)",
        "genre": "Documentary",
    ...
    {
        "id": 76,
        "name": "Needing You... (Goo naam gwa neui)",
    ...
    {
        "id": 88,
        "name": "Rabid Dogs (Kidnapped) (Cani arrabbiati)",
        "genre": "Drama|Thriller",
    ...
    {
        "id": 93,
        "name": "Bloody Pit of Horror (Il boia scarlatto) (Virgins for the Hangman)",
        "genre": "Horror",
    ...
    {
        "id": 98,
        "name": "Five Obstructions, The (Fem benspænd, De)",
        "genre": "Documentary",
    ...
    {
        "id": 115,
        "name": "Rutles: All You Need Is Cash, The",
        "genre": "Comedy",
        "url": "http://dummyimage.com/191x100.png/ff4444/ffffff",
        "year": 1993
    },
    ...
    {
        "id": 117,
        "name": "Lone Wolf and Cub: White Heaven in Hell (Kozure ôkami: Jigoku e ikuzo! Daigorô)",
    ...
    {
        "id": 121,
        "name": "Asterix and Cleopatra (Astérix et Cléopâtre)",
    ...
    {
        "id": 126,
        "name": "Satisfaction (a.k.a. Girls of Summer)",
        "genre": "Comedy|Drama|Romance",
    ...
    },
    {
        "id": 129,
        "name": "Nocturna",
        "genre": "Adventure|Animation|Children|Fantasy|Mystery",
        "url": "http://dummyimage.com/147x100.png/dddddd/000000",
        "year": 1993
    },
    {
        "id": 130,
        "name": "Mystics in Bali (Leák)",
    ...
    {
        "id": 138,
        "name": "Teheran 43: Spy Ring (a.k.a. Assassination Attempt) (Tegeran-43)",
    ...
    {
        "id": 146,
        "name": "Films to Keep You Awake: The Baby's Room (Películas para no dormir: La habitación del niño)",
        "genre": "Horror",
    ...
    {
        "id": 161,
        "name": "Great Escape: The Untold Story",
    ...
    {
        "id": 163,
        "name": "Sex and Zen (Rou pu Tuan zhi tou Qing bao Jian)",
    ...
    {
        "id": 165,
        "name": "Bashu, the Little Stranger (Bashu, gharibeye koochak)",
        "genre": "Drama",
    ...
    {
        "id": 169,
        "name": "Your Life in 65 (Tu vida en 65')",
        "genre": "Comedy|Romance",
        "url": "http://dummyimage.com/177x100.png/ff4444/ffffff",
        "year": 2008
    },
    {
        "id": 170,
        "name": "The Dot and the Line : A Romance in Lower Mathematics",
    ...
    {
        "id": 173,
        "name": "Time Walker (a.k.a. Being From Another Planet)",
        "genre": "Horror|Sci-Fi",
        "url": "http://dummyimage.com/123x100.png/cc0000/ffffff",
        "year": 2013
    },
    ...
    {
        "id": 192,
        "name": "Romance in a Minor Key (Romanze in Moll)",
        "genre": "Drama|Romance",
    ...
    {
        "id": 193,
        "name": "Jönssonligans största kupp",
        "genre": "Comedy|Crime",
    ...
    {
        "id": 221,
        "name": "Khroustaliov, My Car! (Khrustalyov, mashinu!)",
        "genre": "Comedy|Drama",
    ...
    {
        "id": 223,
        "name": "Shaolin Soccer (Siu lam juk kau)",
        "genre": "Action|Comedy",
    ...
    {
        "id": 227,
        "name": "Trials of Henry Kissinger, The",
        "genre": "Documentary",
        "url": "http://dummyimage.com/171x100.png/5fa2dd/ffffff",
        "year": 1992
    },
    ...
    {
        "id": 231,
        "name": "Day the Fish Came Out, The",
        "genre": "Comedy|Sci-Fi",
    ...
    {
        "id": 234,
        "name": "Shadows of Our Forgotten Ancestors (Tini zabutykh predkiv)",
        "genre": "Drama|Romance",
    ...
    {
        "id": 239,
        "name": "Let Sleeping Corpses Lie (Non si deve profanare il sonno dei morti)",
        "genre": "Horror",
    ...
    {
        "id": 241,
        "name": "Crows Zero II (Kurôzu Zero II)",
        "genre": "Action",
    ...
    },
    {
        ...
        "genre": "Comedy|Drama",
        "url": "http://dummyimage.com/202x100.png/cc0000/ffffff",
        "year": 1994
    },
    {
        "id": 249,
        "name": "My Brother's Wife (Mujer de mi hermano, La)",
        "genre": "Drama",
    ...
    {
        "id": 261,
        "name": "Unprecedented: The 2000 Presidential Election",
        "genre": "Documentary",
    ...
    {
        "id": 263,
        "name": "Prelude to War (Why We Fight, 1)",
    ...
    {
        "id": 266,
        "name": "Kids in the Hall: Same Guys, New Dresses",
        "genre": "Comedy|Documentary",
        "url": "http://dummyimage.com/125x100.png/ff4444/ffffff",
        "year": 2008
    },
    ...
    {
        "id": 268,
        "name": "Winnetou: The Red Gentleman",
    ...
    {
        "id": 281,
        "name": "Chocchan's Story (Chocchan monogatari)",
    ...
    {
        "id": 282,
        "name": "Stormbreaker (Alex Rider: Operation Stormbreaker)",
